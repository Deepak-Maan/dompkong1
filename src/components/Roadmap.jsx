...
import Roadmap_half_circle from "../assets/images/half-roadmap-circle.svg";
        ...
        <div className="overflow-x-clip">
            <div className=" min-h-[1044px] pb-4 sm:pb-6 xl:pb-0">
                ...
                <div className="max-w-[1234px] mx-auto px-3 min-h-[558px] flex flex-wrap justify-center">
                    <div data-aos="fade-left" className="w-[100%] xl:w-[36%] pb-6 xl:pb-0 xl:min-h-[558px] flex items-center relative justify-center xl:justify-start">
                    ...
                    <div className="w-[100%] xl:w-[64%] relative flex flex-col gap-y-6">
                        <div data-aos="fade-left" className="flex items-center xl:max-w-[903px] xl:absolute xl:top-[0] xl:left-[-24%] group">
                            ...
                            <div className="w-[76px] h-[76px] bg-white text-black font-montserrat text-[20px] not-italic font-black rounded-[50%] flex justify-center items-center leading-[108.744%] xl:ml-6 mr-4 sm:mr-[43px] shrink-0 group-hover:bg-[#FDDA60] group-hover:shadow-[0px_4px_21px_rgba(253,218,96,0.70)] duration-300">20%</div>
                            <div className="flex flex-col gap-y-2 xl:max-w-[593px]">
                                <h3 className="text-white font-azo text-[20px] not-italic font-normal leading-[108.744%]">Phase 1</h3>
                                <p className="text-white font-montserrat text-[12px] sm:text-base not-italic font-normal leading-[160%]">Mi amet elementum, posuere tempus odio eu lacinia. Natoque arcu viverra ullamcorper condimentum massa laoree</p>
                            </div>
                        </div>
                        <div data-aos="fade-left" className="flex items-center w-full xl:max-w-[806px] xl:absolute xl:top-[20%] xl:left-[-8%] group">
                            ...
                            <div className="w-[76px] h-[76px] bg-white text-black font-montserrat text-[20px] not-italic font-black rounded-[50%] flex justify-center items-center leading-[108.744%] xl:ml-[41px] mr-4 sm:mr-[43px] shrink-0 group-hover:bg-[#FDDA60] group-hover:shadow-[0px_4px_21px_rgba(253,218,96,0.70)] duration-300">40%</div>
                            <div className="flex flex-col gap-y-2 xl:max-w-[593px]">
                                <h3 className="text-white font-azo text-[20px] not-italic font-normal leading-[108.744%]">Phase 2 </h3>
                                <p className="text-white font-montserrat sm:text-base text-[12px] not-italic font-normal leading-[160%]">Amet viverra diam netus aenean at mauris, facilisis quis. Urna euismod sed ultricies arcu ullamcorper </p>
                            </div>
                        </div>
                        <div data-aos="fade-left" className="flex items-center w-full xl:max-w-[779px] xl:absolute xl:top-[40%] xl:left-[-4%] group">
                            ...
                            <div className="w-[76px] h-[76px] bg-white text-black font-montserrat text-[20px] not-italic font-black rounded-[50%] flex justify-center items-center leading-[108.744%] xl:ml-[54px] mr-4 sm:mr-[43px] shrink-0 group-hover:bg-[#FDDA60] duration-300 group-hover:shadow-[0px_4px_21px_rgba(253,218,96,0.70)]"> 60%</div>
                            <div className="flex flex-col gap-y-2 xl:max-w-[593px]">
                                <h3 className="text-white font-azo text-[20px] not-italic font-normal leading-[108.744%]">Phase 3</h3>
                                <p className="text-white font-montserrat sm:text-base text-[12px] not-italic font-normal leading-[160%]">Hendrerit massa non sed sit. Lobortis in pulvinar lectus ut in elit nibh faucibus mauris.</p>
                            </div>
                        </div>
                        <div data-aos="fade-left" className="flex items-center w-full xl:max-w-[794px] xl:absolute xl:bottom-[25%] xl:left-[-7%] group">
                            ...
                            <div className="w-[76px] h-[76px] bg-white text-black font-montserrat text-[20px] not-italic font-black rounded-[50%] flex justify-center items-center leading-[108.744%] xl:ml-[41px] mr-4 sm:mr-[43px] shrink-0 group-hover:bg-[#FDDA60] group-hover:shadow-[0px_4px_21px_rgba(253,218,96,0.70)] duration-300">80%</div>
                            <div className="flex flex-col gap-y-2 xl:max-w-[593px]">
                                <h3 className="text-white font-azo text-[20px] not-italic font-normal leading-[108.744%]">Phase4</h3>
                                <p className="text-white font-montserrat sm:text-base text-[12px] not-italic font-normal leading-[160%]">Ut egestas lacus nec varius blandit volutpat, malesuada nunc, nisl. Nisl mattis convallis lacus tristique.</p>
                            </div>
                        </div>
                        <div data-aos="fade-left" className="flex items-center w-full xl:max-w-[857px] xl:absolute xl:bottom-[4%] xl:left-[-17%] group duration-300">
                            ...
                            <div className="w-[76px] h-[76px] bg-white text-black font-montserrat text-[20px] not-italic font-black rounded-[50%] flex justify-center items-center leading-[108.744%] xl:ml-[24px] mr-4 sm:mr-[43px] shrink-0 group-hover:bg-[#FDDA60] group-hover:shadow-[0px_4px_21px_rgba(253,218,96,0.70)] duration-300">100% </div>
                            <div className="flex flex-col gap-y-2 xl:max-w-[593px]">
                                <h3 className="text-white font-azo text-[20px] not-italic font-normal leading-[108.744%]">Phase 5</h3>
                                <p className="text-white font-montserrat sm:text-base text-[12px] not-italic font-normal leading-[160%]">Faucibus congue risus nisl dictum. A, viverra malesuada nunc varius. Ut dignissim mauris eu sed nisl neque. </p>
                            </div>
                        </div>
                    </div>
                </div>
