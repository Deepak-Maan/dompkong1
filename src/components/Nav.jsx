...
const Hero = () => {
  return (
    <div className='xl:min-h-screen min-h-[60vh] relative bg-hero-gradient overflow-x-clip'>
      ...
      <div className='max-w-[1140px] mx-auto px-3 '>
        <div className='flex justify-center relative items-center  flex-col sm:flex-row'>
          ...
          <button className='text-black  duration-300 font-azo absolute border border-[#FDDA60] hidden sm:flex right-0 top-[20%] bg-[#FDDA60] rounded py-4 px-6 shadow-yellow text-base fontf-normal uppercase before:z-[-1] before:transition-all before:ease-linear before:duration-300 before:absolute before:left-[-100%] before:hover:left-0 before:hover:w-full before:top-0 before:w-full before:h-full before:bg-black overflow-hidden before:rounded before:hover:text-white hover:text-white z-[1]'>cONNECT wALLET</button>
          <button className='text-black before:z-[-1] relative  before:hover:tebefore:z-[-1] before:transition-all before:ease-linear before:duration-300 before:absolute before:left-[-100%] before:hover:left-0 before:hover:w-full before:top-0 before:w-full before:h-full before:bg-black overflow-hidden before:rounded before:hover:text-white hover:text-white z-[1]  duration-300 font-azo sm:hidden border border-[#FDDA60] bg-[#FDDA60] rounded py-4 px-6 shadow-yellow text-base fontf-normal uppercase'>cONNECT wALLET</button>
        </div>
        ...
        <div className=" gap-6 flex relative z-10  flex-wrap justify-center pt-6 pb-4">
          <button className=" before:z-[-1] relative before:transition-all before:ease-linear before:duration-300 before:absolute before:left-[-100%] before:hover:left-0 before:hover:w-full before:top-0 before:w-full before:h-full before:bg-black overflow-hidden before:rounded before:hover:text-white hover:text-white z-[1] rounded border border-[#FDDA60] bg-[#FDDA60] shadow-[0px_4px_16px_0px_rgba(253,218,96,0.50)] py-4 px-6 font-normal text-base leading-[108%] text-black font-azo duration-300">Whitepaper</button>
          <button className=" before:z-[-1] relative before:transition-all before:ease-linear before:duration-300 before:absolute before:left-[-100%] before:hover:left-0 before:hover:w-full before:top-0 before:w-full before:h-full before:bg-black overflow-hidden before:rounded before:hover:text-white hover:text-white z-[1]  rounded border border-[#FDDA60] bg-[#FDDA60] shadow-[0px_4px_16px_0px_rgba(253,218,96,0.50)] py-4 px-6 font-normal text-base leading-[108%] text-black font-azo duration-300">Mint</button>
          <button className="before:z-[-1] relative before:transition-all before:ease-linear before:duration-300 before:absolute before:left-[-100%] before:hover:left-0 before:hover:w-full before:top-0 before:w-full before:h-full before:bg-black overflow-hidden before:rounded before:hover:text-white hover:text-white z-[1] rounded bg-[#FDDA60] border border-[#FDDA60]  shadow-[0px_4px_16px_0px_rgba(253,218,96,0.50)] py-4 px-6 font-normal text-base leading-[108%] text-black font-azo duration-300">Opensea</button>
        </div>
      </div>
    </div>
  )
