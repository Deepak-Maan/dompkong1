    ...
    <div>
      <div className="max-w-[1140px] mx-auto px-3 pb-5 md:pb-[154px]">
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 pt-14 gap-4 ">
          <div className=" rounded-2xl bg-[#222222] overflow-hidden backdrop-blur-lg border border-[#515151] py-[22px] px-[20px] relative hover:bg-[#FDDA60] hover:text-black duration-300 group">
            <span className=" flex flex-col items-center ">
              <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg" >
                ...
                <path className="group-hover:stroke-black"d="M32.668 4.6665V18.6665H46.668" stroke="white"stroke-width="4"stroke-linecap="round"stroke-linejoin="round"/>
                <path className="group-hover:stroke-black"d="M37.3346 30.3335L18.668 30.3335" stroke="white"stroke-width="4" stroke-linecap="round"stroke-linejoin="round"/>
                <path className="group-hover:stroke-black"d="M37.3346 39.6665H18.668"stroke="white"stroke-width="4"stroke-linecap="round"stroke-linejoin="round"/>
                <path className="group-hover:stroke-black"d="M23.3346 21H21.0013H18.668"stroke="white"stroke-width="4"stroke-linecap="round"stroke-linejoin="round"/>
              </svg>
            </span>
            <p className="text-2xl font-semibold text-white leading-[108%] font-Montserrat text-center pt-4 pb-4 group-hover:text-black"> Document</p>
            <p className="text-bace font-Montserrat font-normal text-white  leading-6 text-center group-hover:text-black">Turpis et tortor vel pharetra nibh. Mauris nisl sit vitae viverra amet et. Erat nam molestie. Vitae mollis lacus senectus mattis nisl. Porta , adipiscing sed mus diam amet, ac sed tellus.</p>
          ...
          <div className="rounded-2xl bg-[#222222] overflow-hidden backdrop-blur-lg border border-[#515151] py-[22px] px-[20px]  relative hover:bg-[#FDDA60] hover:text-black duration-300 group">
            <span className=" flex flex-col items-center ">
              <svg width="56"height="56"viewBox="0 0 56 56"fill="none"xmlns="http://www.w3.org/2000/svg" >
                ...
                <path className="group-hover:stroke-black"d="M37.3346 49V11.6667C37.3346 10.429 36.843 9.242 35.9678 8.36683C35.0926 7.49167 33.9056 7 32.668 7H23.3346C22.097 7 20.91 7.49167 20.0348 8.36683C19.1596 9.242 18.668 10.429 18.668 11.6667V49"stroke="white"stroke-width="4"stroke-linecap="round"stroke-linejoin="round"/>
              </svg>
            </span>
            <p className="text-2xl font-semibold text-white leading-[108%] font-Montserrat text-center pt-4 pb-4 group-hover:text-black">Deal</p>
            <p className="text-bace font-Montserrat font-normal text-white  leading-6 text-center group-hover:text-black">Turpis et tortor vel pharetra nibh. Mauris nisl sit vitae viverra amet et. Erat nam molestie. Vitae mollis lacus senectus mattis nisl. Porta , adipiscing sed mus diam amet, ac sed tellus.</p>
            <div className="w-[91px] h-[91px] bg-[#fff] blur-[94px] absolute right-0 top-0"></div>
            <div className="w-[91px] h-[91px] bg-[#fff] blur-[94px] absolute left-0 bottom-0"></div>
          </div>
